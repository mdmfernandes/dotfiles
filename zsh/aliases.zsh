...
alias gld='git log --no-merges --patch'
alias glm='git log'
alias gls='git log --stat --no-merges'
alias glsm='git log --stat'
alias glg='git log --graph'
alias glga='git log --graph --decorate --all'
alias glo='git log --oneline --decorate --no-merges'
alias glog='git log --oneline --decorate --graph'
alias gloga='git log --oneline --decorate --graph --all'
alias glom='git log --oneline --decorate'
alias glon='git log --oneline --no-decorate --no-merges'
alias gmf='git merge --ff-only'
alias gp='git push'
alias gpd='git push --dry-run'
alias gpf='git push --force-with-lease'
alias grst='git reset --mixed'
